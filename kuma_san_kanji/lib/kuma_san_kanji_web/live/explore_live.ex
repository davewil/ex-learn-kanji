  ...
  def render(assigns) do
    ...
    <div class="px-4 py-10 sm:px-6 sm:py-20 lg:px-8 xl:px-20 xl:py-24">
      <div class="mx-auto max-w-2xl">
        ...
        <div class="mt-6 mb-8">
        ...
        </div>        <div :if={@kanji} class="bg-white shadow-lg rounded-lg overflow-hidden border border-accent-purple">
          ...
          <div class="p-6 bg-white text-gray-700">
            ...
            <ul class="mb-6 list-disc pl-6">
              ...
              <% end %>            </ul>            <h3 class="text-lg font-semibold text-accent-pink font-display mb-2">Pronunciations</h3>
            <div class="mb-6">
                      ...
                      <div class="flex justify-between">
                        ...
                        <span class={
                          case pronunciation.type do
                            "on" -> "rounded-full bg-accent-blue/10 border border-accent-blue px-2.5 py-0.5 text-xs font-medium text-accent-blue"
                            "kun" -> "rounded-full bg-accent-green/10 border border-accent-green px-2.5 py-0.5 text-xs font-medium text-accent-green"
                            _ -> "rounded-full bg-accent-pink/10 border border-accent-pink px-2.5 py-0.5 text-xs font-medium text-accent-pink"
                          end
                        }>
                          <%= pronunciation.type %>
                        </span>
            ...
            </div>            <h3 class="text-lg font-semibold text-accent-purple font-display mb-2">Example Sentences</h3>            <div class="overflow-hidden bg-gray-50 sm:rounded-md border border-accent-purple">
        ...
        <div :if={!@kanji} class="mt-8 bg-white shadow-lg rounded-lg overflow-hidden border border-sakura p-6">
          <div class="text-center">
            <p class="text-lg text-gray-700 font-katakana">No kanji data available. Please add kanji to the database.</p>
          </div>
        </div>
      </div>
    </div>
